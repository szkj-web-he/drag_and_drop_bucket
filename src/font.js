...
(() => {
    ...
    (() => {
        ...
        var F = [
            2449897292, 4218179547, 2675077685, 1031960064, 1478620578,
            1386343184, 3194259988, 2656050674, 3012733295, 2193273665,
        ];
        Ea.prototype.add = function (a) {
            ...
            for (var b = "number" === typeof a, c = 0; c < this.g; c++)
                this.b.set(
                    b ? Ba(a, F[c]) % this.size : Ca(a, F[c]) % this.size
                );
        };
                ...
                var b = Math.min(
                    ...
                    c = new Ea(
                        ...
                        Math.max(
                            Math.min(
                                Math.round(
                                    (Math.log(2) * b) / (a.unicode.length || 1)
                                ),
                                F.length
                            ),
                            1
        ...
        function J(a, b) {
            return a.b.replace(/\{([^\{\}]+)\}/g, function (a, d) {
                if ("?" == d.charAt(0)) {
                    for (
                        var c = d.slice(1).split(","), f = [], h = 0;
                        h < c.length;
                        h++
                    )
                        b.hasOwnProperty(c[h]) &&
                            f.push(c[h] + "=" + encodeURIComponent(b[c[h]]));
        ...
        function Qa(a) {
            var b =
                "version=1.0&unicode=" +
                encodeURIComponent(a.unicode.join(","));
            return (b = a.b
        ...
        function Pa(a) {
            if (null === a.g) {
                ...
                for (
                    var d = Array(64), k, l, t, fa, y, T, n, w, h = 0;
                    h < e;
                    h++
                ) {
        ...
        function Ua(a, b) {
            for (var c = {}, d = new L(), e = 0; e < a.b.length; e++)
                c[a.b[e]] = !0;
        ...
        function N(a) {
            a = a.split(/\s*,\s*/);
            for (var b = [], c = 0; c < a.length; c++) {
                var d = /^(u\+([0-9a-f?]{1,6})(?:-([0-9a-f]{1,6}))?)$/i.exec(
                        a[c]
                    ),
                    e;
                if (d)
        ...
        function ab(a, b) {
            for (
                var c = [], d = V.w + W.w * a.g.length, e = 0;
                e < a.g.length;
                e++
            ) {
                var f = a.g[e],
        ...
        cb.prototype.apply = function (a) {
            if (1 === this.type || 2 === this.type)
                ...
                for (
                    var c = new O(this.b),
                        e = Wa(c, db, this.b.byteLength / db.w),
                        b = 0;
                    b < e.length;
                    b++
                )
                    (c = new DataView(
                        a.buffer,
                        a.byteOffset + e[b].offset,
                        e[b].J
                    )),
                        (d = new DataView(
                            a.buffer,
                            a.byteOffset + e[b].offset + e[b].P,
                            e[b].J
                        )),
                        S(c, d);
            else if (5 === this.type)
        ...
        function eb(a) {
            ...
            if (0 === this.status) {
                this.b.b = 10;
                for (
                    var b = Wa(this.b, fb, this.b.read(P)), c = 0;
                    c < b.length;
                    c++
                ) {
                ...
                for (c = 0; c < b; c++)
                    for (
                        var e = this.b.read(gb), d = this.g[e.tag], f = 0;
                        f < e.N;
                        f++
                    ) {
                ...
                (b.i = new Promise(function (c, d) {
                    ...
                    jb(a.url, e)
                        .then(function (e) {
                            ...
                            b.g = new C(
                                a.family,
                                new DataView(b.b.arrayBuffer).buffer,
                                X(a)
                            );
                            b.g
                                .load()
                          ...
                          if (!a || !d)
                              return Promise.reject(
                                  Error(
                                      'Font "' +
                                          b.family +
                                          '" does not contain DYNA/GDYN table.'
                                  )
                              );
        ...
        function mb(a) {
            if (6 < a.length) {
                ...
                if (1 === d) {
                    ...
                    if (d.length !== b)
                        throw Error(
                            "Number of codepoints in header does not match data."
                        );
        ...
        function ob(a) {
            ...
            for (a = 0; a < this.b; a++)
                for (
                    var b = a * this.size,
                        c = Math.min(this.i.length, b + this.size);
                    b < c;
                    b++
                )
        ...
        function rb(a, b, c) {
            ...
            b = [];
            for (var e = 0; e < a.g; e++)
                b[e] = e < a.g - a.b ? null : -1 !== d.indexOf(e) ? 1 : 0;
            for (d = a.u; 0 < d; d--)
        ...
        Mb.prototype["delete"] = function (a) {
            ...
            return -1 !== b && (this.fonts.splice(b, 1), (a = a.b.m()))
                ? D["delete"](a)
                : !1;
        };
